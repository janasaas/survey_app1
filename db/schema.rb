...
ActiveRecord::Schema.define(version: 20140410131105) do
  ...
  add_index "responses", ["survey_id", "agent_id", "surveyee_id"], name: "index_responses_on_survey_id_and_agent_id_and_surveyee_id", unique: true, using: :btree
